...
class DetailVC: UIViewController {
    ...
    func updateUserInterface() {
        ...
        let dateString = formatTimeForTimeZone(unixTime: location.currentTime, timeZone: location.timeZone)
    ...
    func formatTimeForTimeZone(unixTime: TimeInterval, timeZone: String) -> String {
